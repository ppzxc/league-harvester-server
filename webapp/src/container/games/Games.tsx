...
export const gameColumn: GridColDef[] = [
  ...
  {field: 'createdDate', headerName: 'CREATED_DATE', width: 150},
  {field: 'lastModifiedDate', headerName: 'LAST_MODIFIED_DATE', width: 150},
];
...
const Games = () => {
  ...
  const {isLoading, error, data, isFetching} = useQuery({
    ...
    queryFn: async (): Promise<Hateoas> => {
      ...
      const res = await axios.get<Hateoas>("/api/v1/games", {
        method: 'GET',
        headers: {
